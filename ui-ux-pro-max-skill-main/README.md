...
**Supported:** Antigravity, Cursor, Windsurf, Claude Code, Codex CLI, Continue, Gemini CLI, OpenCode, Qoder, CodeBuddy, Droid (Factory)
...
> Note: If you installed via another assistant, replace `.agents/skills/` with the respective folder in the commands below.

```bash
# Generate design system with ASCII output
python3 .agents/skills/ui-ux-pro-max/scripts/search.py "beauty spa wellness" --design-system -p "Serenity Spa"

# Generate with Markdown output
python3 .agents/skills/ui-ux-pro-max/scripts/search.py "fintech banking" --design-system -f markdown

# Domain-specific search
python3 .agents/skills/ui-ux-pro-max/scripts/search.py "glassmorphism" --domain style
python3 .agents/skills/ui-ux-pro-max/scripts/search.py "elegant serif" --domain typography
python3 .agents/skills/ui-ux-pro-max/scripts/search.py "dashboard" --domain chart

# Stack-specific guidelines
python3 .agents/skills/ui-ux-pro-max/scripts/search.py "form validation" --stack react
python3 .agents/skills/ui-ux-pro-max/scripts/search.py "responsive layout" --stack html-tailwind
```
...
python3 .agents/skills/ui-ux-pro-max/scripts/search.py "SaaS dashboard" --design-system --persist -p "MyApp"

# Also create a page-specific override file
python3 .agents/skills/ui-ux-pro-max/scripts/search.py "SaaS dashboard" --design-system --persist -p "MyApp" --page "dashboard"
```
...
.agents/                     # Local dev/test for Antigravity skill
...
See [ANTIGRAVITY.md](ANTIGRAVITY.md) for detailed development guidelines.
